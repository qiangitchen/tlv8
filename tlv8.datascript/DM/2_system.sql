...
CREATE TABLE sa_oprolerole (
  SID varchar2(36) NOT NULL,
  SROLEID varchar2(36) NOT NULL,
  SPARENTROLE varchar2(36) NOT NULL,
  VERSION integer
);
alter table sa_oprolerole add primary key (SID);

CREATE TABLE sa_opsenddocdist (
  SID varchar2(36) NOT NULL,
  SCUROGNID varchar2(64),
  SDISOGNID varchar2(64),
  SDISOGNNAME varchar2(128),
  SDISOGNFID varchar2(1024),
  SDISOGNFNAME varchar2(2048),
  VERSION integer
);
alter table sa_opsenddocdist add primary key (SID);
create unique index SA_OPSENDDOCDIST_OGNID on sa_opsenddocdist(SCUROGNID);

CREATE TABLE sa_opsenddocogn (
  SID varchar2(36) NOT NULL,
  SCUROGNID varchar2(64),
  SLIMIT integer DEFAULT 0,
  VERSION integer
);
alter table sa_opsenddocogn add primary key (SID);

CREATE TABLE sa_portelinfo (
  SID varchar2(100) NOT NULL,
  STHEMETYPE varchar2(10),
  SPSNDESKINFO clob,
  SPERSONID varchar2(100),
  VERSION integer
);
alter table sa_portelinfo add primary key (SID);
...
alter table sa_project add primary key (SID);
