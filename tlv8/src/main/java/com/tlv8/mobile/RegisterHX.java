...
public class RegisterHX {
	...
	private static String doLogin(String url, String param) {
		URL loginURL;
		String result = "";
		try {
	 ...
	 * @return 所代表远程资源的响应结果
	 */
	public static String sendPost(String url, String param, String access_token) {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			for (int i = 0; i < personlist.size(); i++) {
				...
				String username = PinyinHelper.toHanYuPinyinString(m.get("SCODE").toString(), format, "", false);
				username = username.trim();
				String nickname = m.get("SNAME").toString();
				...
				JSONObject p = personjsona.getJSONObject(0);
