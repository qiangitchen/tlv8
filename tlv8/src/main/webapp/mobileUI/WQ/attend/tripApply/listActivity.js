...
function initPage() {
	var sql = "select FID,FREASON,FENDADDR,FTRIPTYPE,FCREATEDATE from WQ_TRIP_APPLY where FCREATORID = '"
...
function viewDeatail(obj) {
	...
	var url = "tripApply1.html?sData1=" + rowid + "&option=view";
