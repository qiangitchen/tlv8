...
function initPage() {
	...
	var sql = "select FID,FCONTENT,FISCONFORM,FCREATEDATE,FDESCRIBE from WQ_TOUR_QUALITY where FMAINID='"+rowid+"'  order by FCREATEDATE desc";
...
function initType() {
	var html = "";
	var sql = "select FID,FTYPENAME from WQ_BASE_TOUR_QUALITY_TYPE where FSTATUS=1";
