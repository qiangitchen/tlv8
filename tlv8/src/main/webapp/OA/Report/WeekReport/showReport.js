function init() {
	var sqlStr = "SELECT * FROM SHOW_OA_RE_WEEKREPORT T  WHERE T.FPERSONID='"
...
function openWin(id) {
	justep.yn.portal.openWindow('周报详细',
...
// 更多
function more() {
	justep.yn.portal.openWindow('周报查看',
			'/OA/Report/WeekReport/reportLookList.html');
}
