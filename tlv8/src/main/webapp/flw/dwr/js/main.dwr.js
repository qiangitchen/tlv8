...
ElementList.addNode = function(json){
	...
	if(json.type=="start"){
		n.append("<td class='nimg'><img src='img/start.png'></td>");
	}else if(json.type=="end"){
		n.append("<td class='nimg'><img src='img/end.png'></td>");
	}else if(json.type=="condition"){
		n.append("<td class='nimg'><img src='img/fork.png'></td>");
	}else{
		n.append("<td class='nimg'><img src='img/biz.png'></td>");
	}
...
ElementList.addLine = function(json){
	...
	if(json.shape=="polyline"){
		n.append("<td class='nimg'><img src='img/transition.png'></td>");
	}else{
		n.append("<td class='nimg'><img src='img/forward.gif'></td>");
	}
