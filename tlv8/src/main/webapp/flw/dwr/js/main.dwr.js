...
var MenuAction = {
    ...
    grid: function (o) {
        ...
        if (obj == '') {
            document.getElementById("drawView").style.backgroundImage = 'url(images/bg.jpg)';
            $(o).addClass('checked');
        } else {
...
ElementList.addNode = function (node) {
    ...
    if (node.type == "start") {
        n.append("<td class='nimg'><img src='process_icons/start.png'></td>");
    } else if (node.type == "end") {
        n.append("<td class='nimg'><img src='process_icons/end.png'></td>");
    } else if (node.type == "condition") {
        n.append("<td class='nimg'><img src='process_icons/fork.png'></td>");
    } else {
        n.append("<td class='nimg'><img src='process_icons/biz.png'></td>");
    }
...
ElementList.addLine = function (line) {
    ...
    if (line.shape == "polyline") {
        n.append("<td class='nimg'><img src='process_icons/transition.png'></td>");
    } else {
        n.append("<td class='nimg'><img src='process_icons/forward.gif'></td>");
    }
