...
//			}
	...
	if ($('div').layout) {
		var treeTable = '<div class="easyui-layout" fit="true" border="false" id="'
				+ div.id + '_tree">';
		treeTable += '<div data-options="region:\'north\',border:false" style="height:35px;overflow:hidden;">';
		treeTable += "<table><tr><td><input id='"
				+ div.id
				+ "_tree_quick_position' type='text' style='width:100%;height:30px;border:1px solid #ddd;'></input></td>";
		treeTable += "<td style='width:2px'/><td align='left'>";
		treeTable += "<a id='"
				+ div.id
				+ "_quick' href='javascript:void(0)' class='toobar_item'><img src='"
				+ $dpimgpath
