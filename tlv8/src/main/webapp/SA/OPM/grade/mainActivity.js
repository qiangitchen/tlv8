...
function btnInsertManagementsClick() {
	var surl = "/SA/OPM/dialogs/selectMultiOrgs/selectMultiOrgs.html";
	tlv8.portal.dailog.openDailog("选择管理的组织", surl, 750, 450, function(r) {
...
function btnInsertRoleManagementsClick() {
	var surl = "/SA/OPM/dialogs/selectMultiRoles/selectMultiRoles.html";
	tlv8.portal.dailog.openDailog("选择管理的角色", surl, 650, 450, function(r) {
